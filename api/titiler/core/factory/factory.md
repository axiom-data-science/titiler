...
class BaseTilerFactory(
    ...
    path_dependency: Callable[..., Any] = <function DatasetPathParams at 0x7f8c2992d790>,
    ...
    colormap_dependency: Callable[..., Union[Dict[int, Tuple[int, int, int, int]], Sequence[Tuple[Tuple[Union[float, int], Union[float, int]], Tuple[int, int, int, int]]], NoneType]] = <function ColorMapParams at 0x7f8c29aa4a60>,
    ...
    tms_dependency: Callable[..., morecantile.models.TileMatrixSet] = <function TMSParams at 0x7f8c2c4dc3a0>,
    router_prefix: str = '',
